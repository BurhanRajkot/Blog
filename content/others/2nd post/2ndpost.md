---
title: 'Life Update + PC Resurrection Arc'
description: 'Chaos, hackathons, fried motherboards, and new projects.'
date: 2025-12-10T00:00:00+05:30
draft: false
categories: ['Others']
tags: ['journal', 'life', 'tech']
showToc: false
---
...
Apparently this excessive load somehow **fried my motherboard**.
...
Luckily, updating drivers slapped it back to reality.
...
- I’m also working on a **new project** (announcement soon).
  ...
  I need emotional support or at least a "hi".

## Things to look forward to

- A **new project** coming soon
- **Unity 2D course** continuation
- **Python** learning
- **Data Science**
- **Math**
- **Consumer Electronics**

I’m really enjoying tinkering with AutoCAD, ESP32, and other electronics.
Plus I have a BEE KT (lol), so all this tinkering technically counts as studying.
